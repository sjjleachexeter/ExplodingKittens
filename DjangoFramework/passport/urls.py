...
from . import views
urlpatterns = [
    path("display/<str:product_id>", views.display_passport, name="passport_display"),
    ...
    path("edit_passport/<str:product_id>", views.edit_passport, name="edit_passport"),
    path("edit_claims/<str:product_id>", views.edit_claims, name="edit_claims"),
    path("edit_evidence/<str:product_id>", views.edit_evidence, name="edit_evidence"),
